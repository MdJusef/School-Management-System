                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-6">
                            <div class="card-body p-4 p-sm-5">
                                ...
                                <form class="form-body" action="{{route('teacher-login')}}" method="post">
                                    @csrf
                                    <div class="row g-3">
                                        <div class="col-12">
                                            <label for="inputChoosePassword" class="form-label">User name</label>
                                            <div class="ms-auto position-relative">
                                                <div class="position-absolute top-50 translate-middle-y search-icon px-3"><i class="bi bi-envelope-fill"></i></div>
                                                <input name="user_name" type="text" class="form-control radius-30 ps-5" id="inputEmailAddress" placeholder="Enter User name or phone number">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <p class="mb-0">Don't have an account yet? <a href="authentication-signup.html">Teacher Sign up here</a></p>
                                        </div>
                                    </div>
                                </form>
                            </div>
