            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="full blog_img_popular">
                        <img class="img-responsive" src="{{asset($course->image)}}" alt="#" style="height: 275px; width: 350px; " />
                        <a href="{{route('course-details', [ 'slug' => $course->slug ])}}"> <h4>{{ substr($course->course_name,0,25) }}</h4> </a>
                    </div>
                </div>
                @endforeach
{{--                <div class="col-md-4">--}}
...
{{--                </div>--}}
    ...
    <div class="section contact_section" style="background:#12385b;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="full float-right_img" style="margin-top: 110px;">
